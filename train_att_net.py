...
from ovadb.data.custom_dataset_mapper import CustomDatasetMapper, PPDDDatasetMapper
...
def do_test(cfg, model):
    ...
    for d, dataset_name in enumerate(cfg.DATASETS.TEST):
        ...
        if evaluator_type == "lvis":
            ...
            if dataset_name in {"ppdd_ovd_test_all", "ppdd_ovd_test_base", "ppdd_ovd_test_novel", "ppdd_ovd_test_all_debug"}:
...
def do_train(cfg, model, resume=False):
    ...
    if cfg.MODEL.ATTRIBUTE_ON:
        mapper = PPDDDatasetMapper(cfg, True)
