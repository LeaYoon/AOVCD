...
__all__ = ["CustomDatasetMapper", "PPDDDatasetMapper"]

class PPDDDatasetMapper(DatasetMapper):
    @configurable
    def __init__(
        self,
        is_train: bool,
    ...
    def __call__(self, dataset_dict):
        ...
        if "annotations" in dataset_dict:
            ...
            att_labels = torch.tensor([obj["att_vec"] for obj in annos])
            instances.set("gt_att_classes", att_labels)
