...
def _get_ovad_meta(dataset_name, ann_file):
    ...
    thing_classes = ['RC', 'LEC', 'CSSC', 'RDC', 'CJC', 'AC']
...
_PREDEFINED_SPLITS_OVAD = {
    ...
    "ppdd_ovad": ("ppdd/test", "ppdd/ppdd_ovad/ppdd_test_all.json"),
    "ppdd_ovad_boxann": ("ppdd/test", "ppdd/ppdd_ovad/ppdd_test_all.json")
}

for dataset_name, (image_root, json_file) in _PREDEFINED_SPLITS_OVAD.items():
