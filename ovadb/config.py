...
def add_ovadb_config(cfg):
    ...
    # debug
    _C.EVALUATION_ORIGINAL_INDEX = True  # Debug mode, used for debugging the model
    _C.INPUT.REMAP_CATEGORY_ID = False
    _C.INPUT.REMAP_CATEGORY_MAP = []
    ...
    _C.MODEL.ROI_BOX_HEAD.USE_ATTRIBUTE_CLS = (
        False  # Use fixed classifier for open-vocabulary detection
    )
    _C.MODEL.ROI_BOX_HEAD.ZEROSHOT_WEIGHT_PATH = (
        # "datasets/metadata/lvis_v1_clip_a+cname.npy"
        '/home/project/host_workspace/PythonProjects/PPDD_OVCLS/ovad-benchmark-code/output/ovad_cls_att_features/ovad_obj_cls_clipViT-B32_photo+cname.npy'
    )
    _C.MODEL.ROI_BOX_HEAD.ATTRIBUTE_WEIGHT_PATH = (
        # "datasets/metadata/lvis_v1_clip_a+cname.npy"
        '/home/project/host_workspace/PythonProjects/PPDD_OVCLS/ovad-benchmark-code/output/ovad_cls_att_features/ovad_att_clip-ViT-B32_photocrack+catt.npy'
    )
    _C.MODEL.ROI_BOX_HEAD.ZEROSHOT_WEIGHT_DIM = 512
    _C.MODEL.ROI_BOX_HEAD.ATTRIBUTE_WEIGHT_DIM = 512
