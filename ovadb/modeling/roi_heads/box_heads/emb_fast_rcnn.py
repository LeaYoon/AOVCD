...
from ovadb.modeling.roi_heads.attribute_heads.attribute_classifier import PPDDAttributeClassifier
...
class EmbeddingFastRCNNOutputLayers(FastRCNNOutputLayers, LoggedModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if att_cls_score is not None:
            self.att_cls_score = att_cls_score
    ...
    def from_config(cls, cfg, input_shape):
        ...
        if cfg.MODEL.ROI_BOX_HEAD.USE_ATTRIBUTE_CLS:
            ret["att_cls_score"] = PPDDAttributeClassifier(cfg, input_shape)
    ...
    def forward(self, x, classifier_info=None):
        ...
        att_scores = self.att_cls_score(x) if hasattr(self, "att_cls_score") else None
