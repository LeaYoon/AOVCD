...
object_attribute_templates = {
    "has": {
        ...
        "photo": [
            ...
            "a photo of the {noun} which has {attr}",
        ],
    },
    "is": {
        "none": ["{attr} {noun}"],
...
if __name__ == "__main__":
    ...
    if args.save_obj_categories or not args.not_use_object:
        ...
        synonyms = [[cat] for cat in cat_names]  # no synonyms, just the name

        # if set of categories, it regards as a set of synonyms
        for si, sym in enumerate(synonyms):
            ...
            for ti, t in enumerate(temp):
                if t == "Reflective":
                    temp[ti] = "reflective crack"
                elif t == "Verti":
                    temp[ti] = "longitudinal crack"
                elif t == "Edge":
                    temp[ti] = "edge crack"
                elif t == "Corr":
                    temp[ti] = "corrugation crack"
                elif t == "Shov":
                    temp[ti] = "shoving crack"
                elif t == "Disp":
                    temp[ti] = "slippage crack"
                elif t == "Rutt":
                    temp[ti] = "rutting crack"
                elif t == "Depress":
                    temp[ti] = "depression crack"
                elif t == "Construction":
                    temp[ti] = "construction crack"            
                elif t == "Alligator":
                    temp[ti] = "alligator crack"
            synonyms[si] = temp             
    ...
    if args.save_att_categories:
        ...
        """
        ppdd_attributes_path = "/home/project/host_workspace/PythonProjects/PPDD_OVCLS/ovad-benchmark-code/datasets/ppdd/ppdd_ovad/ppdd_att/ppdd_attribute_categories.json"
        with open(ppdd_attributes_path, "r") as f:
